...
<body>
	...
	<div class="container">
		...
		<div class="main">
			<h1>ADD STUDENT</h1>
			<form class="form" action="<%=request.getContextPath() %>/CRUDStudentServlet?action=addStudent" method="post">
				<input type="text" name="name" placeholder="Enter Name" />
				<input type="email" name="email" placeholder="Enter E-Mail" />
				<input type="text" name="contact" placeholder="Enter Contact Number" />
				<input type="text" name="rollNumber" placeholder="Enter Roll Number" />
				<input type="text" name="fees" placeholder="Enter Fees Yes/No" />
				<button class="add-data">ADD STUDENT</button>
			</form>
		</div>
	</div>
</body>
